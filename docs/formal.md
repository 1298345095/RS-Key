...
Both timings are one run each on 2026-08-29, on an Apple M5 Pro (18 cores) at
the default `WORKERS=2`: `safety` over 198 configurations in 3220 s and
`liveness` over 4 in 2032 s — 22 GREEN, 180 RED, no row short of its floor.
