...
Both timings are one run each on 2026-08-30, on an Apple M5 Pro (18 cores) at
the default `WORKERS=2`: `safety` over 202 configurations in 4020 s and
`liveness` over 4 in 2057 s — 24 GREEN, 182 RED, no row short of its floor.
