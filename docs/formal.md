...
76 entries: all 72 executable patches are killed and four are unreachable.
...
the default `WORKERS=2`: `safety` over 204 configurations in 6005 s and
`liveness` over 4 in 1918 s — 25 GREEN, 183 RED, no row short of its floor.
