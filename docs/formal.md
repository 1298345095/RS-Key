...
Both timings are one run each on 2026-09-08, on an Apple M5 Pro (18 cores) at
the default `WORKERS=2`: `safety` over 224 configurations in 5994 s and
`liveness` over 4 in 2116 s — 26 GREEN, 202 RED, no row short of its floor.
