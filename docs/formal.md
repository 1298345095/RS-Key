...
Both timings are one run each on 2026-08-27, on an Apple M5 Pro (18 cores) at
the default `WORKERS=2`: `safety` over 195 configurations in 3225 s and
`liveness` over 4 in 2118 s — 22 GREEN, 177 RED, no row short of its floor.
