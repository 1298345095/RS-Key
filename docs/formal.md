...
Both timings are one run each on 2026-09-02, on an Apple M5 Pro (18 cores) at
the default `WORKERS=2`: `safety` over 214 configurations in 6446 s and
`liveness` over 4 in 2083 s — 26 GREEN, 192 RED, no row short of its floor.
