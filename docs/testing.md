...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
Both tiers are measured runs, not sums. On 2026-09-16, on the Apple M5 Pro (18
cores) of the Kani table above at the default `WORKERS=2`, `safety` came back
over **224 configurations in 8793 s — 25 GREEN, 199 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **2624 s** for its 4, at
