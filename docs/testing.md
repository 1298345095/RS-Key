...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
Both tiers are measured runs, not sums. On 2026-08-30, on the Apple M5 Pro (18
cores) of the Kani table above at the default `WORKERS=2`, `safety` came back
over **202 configurations in 4020 s — 23 GREEN, 179 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **2057 s** for its 4, at
