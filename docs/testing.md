...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
Both tiers are measured runs, not sums. On 2026-08-31, on the Apple M5 Pro (18
cores) of the Kani table above at the default `WORKERS=2`, `safety` came back
over **210 configurations in 6113 s — 24 GREEN, 186 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **2041 s** for its 4, at
