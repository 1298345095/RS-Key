...
`safety` is the nine shipped models, the 84 mutation switches that have a
configuration family of their own (85 `Bug*` switches exist;
`BugDeadTokenAuthorized` has none), floors and the vacuity check.
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
Both tiers are measured runs, not sums. On 2026-09-01, on the Apple M5 Pro (18
cores) of the Kani table above at the default `WORKERS=2`, `safety` came back
over **210 configurations in 6189 s — 24 GREEN, 186 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **2319 s** for its 4, at
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
The original phase-2 baseline is fixed at 31 rows, and the full 79-entry live
roster runs weekly.
...
> <!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
> TLC checks 11 named invariants exhaustively over 77 563 872 distinct states at
