...
`safety` is the nine shipped models, the 80 mutation switches that have a
configuration family of their own (81 `Bug*` switches exist;
...
over **198 configurations in 3220 s — 21 GREEN, 177 RED, and not one row that
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
The original phase-2 baseline is fixed at 30 rows, and the full 72-entry live
roster runs weekly.
