...
`safety` is the nine shipped models, the 79 mutation switches that have a
configuration family of their own (80 `Bug*` switches exist;
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
Both tiers are measured runs, not sums. On 2026-08-29, on the Apple M5 Pro (18
cores) of the Kani table above at the default `WORKERS=2`, `safety` came back
over **195 configurations in 3225 s — 21 GREEN, 174 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **1794 s** for its 4, at
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
The original phase-2 baseline is fixed at 30 rows, and the full 71-entry live
roster runs weekly.
...
> <!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
> TLC checks 8 named invariants exhaustively over 77 563 872 distinct states at
