...
`safety` is the nine shipped models, the 81 mutation switches that have a
configuration family of their own (82 `Bug*` switches exist;
...
over **204 configurations in 4117 s — 23 GREEN, 181 RED, and not one row that
missed what `floors.txt` asks of it**; `liveness` took **2032 s** for its 4, at
...
<!-- Generated by scripts/run_count_gate.py --write; do not edit. -->
The original phase-2 baseline is fixed at 31 rows, and the full 73-entry live
roster runs weekly.
