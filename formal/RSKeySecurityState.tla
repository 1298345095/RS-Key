...
\* (crates/rsk-fido/src/clientpin.rs:1115-1121). What it deliberately does NOT
\* touch is the CTAP session: no ECDH regeneration, no RAM 3-strikes lock, no
\* journal (crates/rsk-fido/src/clientpin.rs:1109-1113). So this is not a
...
\* (crates/rsk-fido/src/clientpin.rs:1149-1151), which is the same shape
...
\* (crates/rsk-fido/src/clientpin.rs:1115-1121) and grants NOTHING host-visible:
