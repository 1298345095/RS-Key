...
VARIABLES
    ...
    \* means: `validated = !code_set` (crates/rsk-oath/src/lib.rs:1256-1260), so
...
\* (crates/rsk-oath/src/lib.rs:1222-1226) -- three functions, one meaning.
ClearedFor(h, a) ==
...
\* (crates/rsk-oath/src/lib.rs:1230-1231), which is a recorded, deliberate asymmetry
...
\* OATH VERIFY PIN (crates/rsk-oath/src/lib.rs:1188-1209) clears BOTH flags at
...
\* both halves (crates/rsk-oath/src/lib.rs:1158-1159). Before it, `0xB2` VERIFY
...
\* (crates/rsk-oath/src/lib.rs:538-540) -- measured on a YubiKey 5.7.4 from a
...
\* (crates/rsk-oath/src/lib.rs:385-393).
OathSetCode ==
    /\ sel = Oath
    /\ ~oathCodeSet
    /\ oathCodeSet' = TRUE
...
\* rather than OpenPGP's (crates/rsk-fido/src/reset.rs:235-277). Modelled as a
...
\* the standing unlock (crates/rsk-oath/src/lib.rs:538-540), because a MAC
\* challenge-response has no retry counter for a refusal to protect.
\*
