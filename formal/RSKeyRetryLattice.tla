...
CONSTANTS
    ...
    \* crates/rsk-piv/src/lib.rs:1245-1247 (check_ref) and
    ...
    BugUseWhenBlocked,
    \* The decrement that IS the anti-bruteforce gate: crates/rsk-piv/src/lib.rs:1263
    ...
    \* crates/rsk-piv/src/lib.rs:1396 (`check_ref(EF_PUK, ..)` opens
...
(***************************************************************************)
(* VERIFY. crates/rsk-piv/src/lib.rs:1240-1303 (check_ref) and              *)
