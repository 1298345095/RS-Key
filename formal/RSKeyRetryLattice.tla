...
CONSTANTS
    ...
    \* unblock_pin_with_puk) and crates/rsk-openpgp/src/pin.rs:885 (`check_pin(EF_RC,
...
\* it shares PW1's verifier and counter (crates/rsk-openpgp/src/pin.rs:656), so it
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:580-587, crates/rsk-openpgp/src/pin.rs:862-912),
...
\* it gates on a live PW3 SESSION (`sess.has_pw3`, crates/rsk-openpgp/src/pin.rs:917),
\* which is the seam
