...
\* it shares PW1's verifier and counter (crates/rsk-openpgp/src/pin.rs:579), so it
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:580-587, crates/rsk-openpgp/src/pin.rs:785-835),
...
\* it gates on a live PW3 SESSION (`sess.has_pw3`, crates/rsk-openpgp/src/pin.rs:840),
\* which is the seam
