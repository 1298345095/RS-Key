...
/// sites actually use:
///
/// - the **UV** shape — `getassertion.rs:390-393`, `makecredential.rs:518-521` —
...
fn no_token_after_invalidation() {
    ...
    for i in 0..STEPS {
        ...
        // A1 — the UV-shaped call sites (getassertion.rs:390-393,
        // makecredential.rs:518-521): their `user_verified()` conjunct is false after
